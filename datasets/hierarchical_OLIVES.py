...
class OLIVES_HierarchihcalDataset(Dataset):
    def __init__(self, list_file, class_map_file, args, transform=None):
        ...
        for i in range(num_data):
            ...
            # print(self.data_dict['patient_ids'][i])
            # exit()
            patient_id = self.class_map[str(self.data_dict['patient_ids'][i])]
            ...
            self.filenames.append(args.root_data+filename)
